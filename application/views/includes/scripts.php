...
<script src="<?=base_url('assets/app/services.js?v=1.1.0');?>"></script>
<script src="<?=base_url('assets/app/helpers.js?v=1.1.0');?>"></script>
<script src="<?=base_url('assets/js/plugins/notify/bootstrap-notify.js');?>"></script>
